(function (root, factory) {
    ...
    templatizer["pages"]["addCodes"] = function tmpl_pages_addCodes() {
        return '<section class="page request-code"><div class="prompt"></div><h4>Add Codes: <h4 data-hook="title"></h4></h4><div role="group" aria-label="Justified button group" class="btn-group btn-group-lg btn-group-justified"> <div role="group" class="btn-group"><button class="btn btn-default viewCodes">View Codes<span class="label label-primary pull-left">Alt + Q</span></button></div><div role="group" class="btn-group"><button class="btn btn-default addCodes">Product Page<span class="label label-primary pull-left">Alt + W</span></button></div><div role="group" class="btn-group"> <button class="btn btn-default editProduct">Edit Product<span class="label label-primary pull-left">Alt + E</span></button></div></div><form data-hook="addCodesForm"><fieldset data-hook="field-container"></fieldset><div class="buttons"><button data-hook="reset" type="submit" class="btn">Add Codes</button></div></form></section>';
    };
    ...
    templatizer["pages"]["editProduct"] = function tmpl_pages_editProduct() {
        return '<section class="page edit-product"><div class="prompt"></div><h4>Edit Product: <h4 data-hook="title"></h4></h4><div role="group" aria-label="Justified button group" class="btn-group btn-group-lg btn-group-justified"> <div role="group" class="btn-group"><button class="btn btn-default viewCodes">View Codes<span class="label label-primary pull-left">Alt + Q</span></button></div><div role="group" class="btn-group"><button class="btn btn-default addCodes">Add Codes<span class="label label-primary pull-left">Alt + W</span></button></div><div role="group" class="btn-group"> <button class="btn btn-default editProduct">Product Page<span class="label label-primary pull-left">Alt + E</span></button></div></div><form data-hook="add-product-form"><fieldset data-hook="field-container"></fieldset><div class="buttons"><button data-hook="reset" type="submit" class="btn">Submit</button></div></form></section>';
    };
    ...
    templatizer["pages"]["productPage"] = function tmpl_pages_productPage() {
        return '<section class="page product-page"><div class="prompt"></div><h4 data-hook="title"></h4><div role="group" aria-label="Justified button group" class="btn-group btn-group-lg btn-group-justified"> <div role="group" class="btn-group"><button class="btn btn-default viewCodes">View Codes<span class="label label-primary pull-left">Alt + Q</span></button></div><div role="group" class="btn-group"><button class="btn btn-default addCodes">Add Codes<span class="label label-primary pull-left">Alt + W</span></button></div><div role="group" class="btn-group"> <button class="btn btn-default editProduct">Edit Product<span class="label label-primary pull-left">Alt + E</span></button></div></div><p>         </p><p>Real-Time data will be displayed here ...</p></section>';
    };

    // pages/viewCodes.jade compiled template
    templatizer["pages"]["viewCodes"] = function tmpl_pages_viewCodes() {
        return '<section class="page request-code"><div class="prompt"></div><h4>Available Codes: <h4 data-hook="title"></h4></h4><div role="group" aria-label="Justified button group" class="btn-group btn-group-lg btn-group-justified"> <div role="group" class="btn-group"><button class="btn btn-default viewCodes">Product Page<span class="label label-primary pull-left">Alt + Q</span></button></div><div role="group" class="btn-group"><button class="btn btn-default addCodes">Add Codes<span class="label label-primary pull-left">Alt + W</span></button></div><div role="group" class="btn-group"> <button class="btn btn-default editProduct">Edit Product<span class="label label-primary pull-left">Alt + E</span></button></div></div><ul data-hook="availableCodes-list" class="list-group"></ul></section>';
    };
